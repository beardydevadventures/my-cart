				...
				<div class="customize panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="row">
							...
							<div class="col-lg-3 relative">
								<input type="text" class="form-control button-font-active-color" name="button-font-active-color" value="<?php echo($colArray['button-font-active-color']); ?>" placeholder="Choose a color"/>
