		...
		<div class="wrapper clearfix">
				...
				<table class="orders table table-hover">
					...
					<tbody>
						<?php 
							...
							$order = $dbh->query("SELECT o.id, o.dateTimeOrdered, o.dateTimeSent, o.deliveryAddr, c.fname, c.lname
			...
			<div class="panel panel-default">
				...
				<table class="orders table table-hover">
					...
					<tbody>
						<?php 
						$products = $dbh->query("SELECT p.name, pv.description, po.quantity, pc.cost
								FROM product p, product_order po, product_cost pc, product_variation pv
								WHERE po.orderId = '$oid'
								AND po.productId = p.id
								AND po.productVarId = pv.id
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<p>Would you like to dispatch <b>Order # <?php echo($oItem['id']);?>?</b></p>
