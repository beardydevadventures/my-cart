...
<?php
	...
	if( isset($_GET['token']) && !empty($_GET['token']) ) { // Token parameter exists
		...
		if( is_array($response) && $response['ACK'] == 'Success') { // Payment successful
			...
			$sth = $dbh->query("INSERT INTO  `mycartdb`.`order` (
								`customerId` ,
								`dateTimeOrdered` ,
								`paypalId` ,
								`deliveryAddr`
...
?>
	<p>Thank you <?php echo($checkoutDetails['PAYMENTREQUEST_0_SHIPTONAME']);?> for your payment. Your transaction has been completed and a receipt for your purchase has been emailed to you. You may log into your account at <a href="http://www.paypal.com.au">www.paypal.com.au</a> to view details of this transaction.</p>
<?php
